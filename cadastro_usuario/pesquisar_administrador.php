...
$result_usuario = "SELECT * FROM usuarios WHERE nome LIKE '%$valor_pesquisar%'";
$resultado_usuario = mysqli_query($conexao, $result_usuario);

//Selecionar os usuarios a serem apresentado na página **** '%$valor_pesquisar%' limit $incio, $quantidade_pg ****
$result_usuarios = "SELECT * FROM usuarios WHERE nome LIKE '%$valor_pesquisar%'";
          ...
          <div class="container">
            <div class="container theme-showcase" role="main">
                  ...
                  <div class="col-sm-6 col-md-6">
                    <form class="form-inline" method="GET" action="pesquisar_administrador.php">
                      <div class="form-group">
						...
						<a class="btn btn-primary" href="consulta_usuario_administrador.php" role="button">Voltar</a>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="row">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php while($rows_usuarios = mysqli_fetch_assoc($resultado_usuarios)){ ?>
                        <tr>
                          <td>
                            <?php echo $rows_usuarios['id']; ?>
                          </td>
                          <td>
                            <?php echo $rows_usuarios['nome']; ?>
                          </td>
                          <div class="col-md-3">
                            <td class="float-right">
                              <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#myModal<?php echo $rows_usuarios['id']; ?>"><i class='fa fa-eye'></i></button>
                              <button type="button" class="btn btn-xs btn-warning" data-target="#exampleModal">
                                <?php echo "<a href='editar_usuario_administrador.php?id=" . $rows_usuarios['id']. "'><i class='fa fa-edit'></i></a>"?></button>
							  <button type="button" class="btn btn-xs btn-danger">
								<?php echo "<a href='proc_apagar_usuario.php?id=" . $rows_usuarios['id'] . "' data-confirm='Tem certeza que deseja excluir o item selecionado?'><i class='fa fa-trash-alt'></i></a>"?></button>
							</td>						
							</td>
                          </div>
                        </tr>
                ...
                <!--Inicio Modal -->
                <div class="modal fade" id="myModal<?php echo $rows_usuarios['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title text-left" id="myModalLabel"><?php echo $rows_usuarios['nome']; ?></h4> </div>
                      <div class="modal-body">
                        <div class="container-fluid">
                          ...
                          <p>
                            <div class="row">
                              <div class="col-md-6">
                                <?php echo "<strong>E-mail: </strong>".$rows_usuarios['email']; ?></div>
                            </div>
                          </p>
                          <p>
                            <div class="row">
                              <div class="col-md-6">
                                <?php echo'<strong>Login: </strong>'.$rows_usuarios['login']; ?></div>
                            </div>
                          </p>
                          <p>
                            <div class="row">
                              <div class="col-md-4">
                                <?php echo'<strong>Nível de Acesso: </strong>'.$rows_usuarios['nivel_acesso_id']; ?></div>
                            </div>
                          </p>
                        </div>
						<hr class="mb-4">
