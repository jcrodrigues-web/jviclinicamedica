      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 160px">Cadastro de Usuário</h3>
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="recebe_cadastro_usuario.php">
            <div class="row">
              <div class="col-md-8 mb-3">
                <label for="nome">Nome:</label>
                <input type="text" name="nome" class="form-control" id="nome" placeholder="Nome do usuário" value="" required>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="email" class="form-control" id="email" placeholder="meuemail@dominio.com.br" value="">
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="login">Login:</label>
                <input type="text" name="login" class="form-control" id="login" placeholder="Login de acesso" value="" required>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="password" name="senha" class="form-control" id="senha" placeholder="Informe uma senha" value="" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
