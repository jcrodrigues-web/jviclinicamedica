<?php
  ...
  $result_receita = "UPDATE receita SET nomePacienteReceita='$nomePacienteReceita', idadePacienteReceita='$idadePacienteReceita', dataNascPacienteReceita='$dataNascPacienteReceita', convenioPacienteReceita='$convenioPacienteReceita',
