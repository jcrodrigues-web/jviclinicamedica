    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_receita_medico.php" novalidate>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="date" name="dataNascPacienteReceita" class="form-control" id="dataNascPacienteReceita" placeholder="Data de Nascimento" value="<?php echo $row_receita['dataNascPacienteReceita']; ?>" required>
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input type="date" name="dataPacienteReceita" class="form-control" id="dataPacienteReceita" placeholder="Data do dia" value="<?php echo $row_receita['dataPacienteReceita']; ?>"> required>
            ...
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_receita_medico.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
