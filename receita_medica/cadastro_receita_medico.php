    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="recebe_cadastro_receita_medico.php" novalidate>
            <div class="row">
            ...
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a href="../tela_inicial/tela_principal_medico.php" class="btn btn-info"><i class="fa fa-share"></i> Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
