<?php
  ...
  $result_receita = "SELECT * FROM receita WHERE id = '$id'";
    ...
    <div class="wrapper">
      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            <button type="button" id="sidebarCollapse" class="btn btn-info"> <i class="fas fa-align-left"></i> <span>Ocultar barra lateral</span> </button>
             <h3 class="h3" style="margin-left: 150px">Editar Receita</h3>
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_receita_administrador.php" novalidate>
            <div class="row">
              <div class="col-md-2 mb-3">
                <label for="id">Código:</label>
                <input type="text" name="id" class="form-control" id="id" value="<?php echo $row_receita['id']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="cpfPaciente">CPF:</label>
                <input type="text" name="cpfPaciente" class="form-control" id="cpfPaciente" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" size="14" requiredvalue="<?php echo $row_receita['cpfPaciente']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-6 mb-3">
                <label for="nomePacienteReceita">Paciente:</label>
                <input type="text" name="nomePacienteReceita" class="form-control" id="nomePacienteReceita" placeholder="Nome do paciente" value="<?php echo $row_receita['nomePacienteReceita']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-2 mb-3">
                ...
                <input type="text" name="idadePacienteReceita" class="form-control" id="idadePacienteReceita" placeholder="Idade" value="<?php echo $row_receita['idadePacienteReceita']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="dataNascPacienteReceita">Data de Nasc.:</label>
                <input type="date" name="dataNascPacienteReceita" class="form-control" id="dataNascPacienteReceita" placeholder="Data de Nascimento" value="<?php echo $row_receita['dataNascPacienteReceita']; ?>">
              ...
              <div class="col-md-5 mb-3">
                ...
                <select class="custom-select d-block w-100" name="convenioPacienteReceita" id="convenioPacienteReceita" required>
                  <option value="<?php echo $row_receita['convenioPacienteReceita']; ?>">
                    <?php echo $row_receita['convenioPacienteReceita']; ?>
                  </option>
                  <option></option>
            ...
            <div class="row">
              <div class="col-md-5 mb-3">
                ...
                <input type="text" name="medicoPacienteReceita" class="form-control" id="medicoPacienteReceita" placeholder="Nome do médico" value="<?php echo $row_receita['medicoPacienteReceita']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-2 mb-3">
                <label for="crmPacienteReceita">CRM:</label>
                <input type="text" name="crmPacienteReceita" class="form-control" id="crmPacienteReceita" placeholder="CRM" value="<?php echo $row_receita['crmPacienteReceita']; ?>" required>
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-3 mb-3">
                <label for="dataPacienteReceita">Data:</label>
                <input type="date" name="dataPacienteReceita" class="form-control" id="dataPacienteReceita" placeholder="Data do dia" value="<?php echo $row_receita['dataPacienteReceita']; ?>">
            ...
            <div class="row">
              <div class="col-md-11 mb-3">
                ...
                <textarea class="form-control" rows="5" name="receituarioPacienteReceita" id="receituarioPacienteReceita" placeholder="Digite a prescrição médica" required>
                  <?php echo $row_receita['receituarioPacienteReceita']; ?>
                </textarea>
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
            </div>
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_receita_administrador.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
