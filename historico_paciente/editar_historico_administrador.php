<?php
  ...
  $result_historico = "SELECT * FROM historico WHERE id = '$id'";
  $resultado_historico = mysqli_query($conexao, $result_historico);
  $row_historico = mysqli_fetch_assoc($resultado_historico); 
?>
      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 100px">Editar Histórico do Paciente</h3>
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_historico_administrador.php">
            <div class="row">
              <div class="col-md-2 mb-3">
                <label for="nomePaciente">Código:</label>
                <input type="text" name="id" class="form-control" id="id" value="<?php echo $row_historico['id']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-9 mb-3">
                <label for="nomeHistPaciente">Nome:</label>
                <input type="text" name="nomeHistPaciente" class="form-control" id="nomeHistPaciente" value="<?php echo $row_historico['nomeHistPaciente']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" name="convenioHistPaciente" id="convenioHistPaciente" required>
                  <option value="<?php echo $row_historico['convenioHistPaciente']; ?>">
                    <?php echo $row_historico['convenioHistPaciente']; ?>
                  </option>
                  <option></option>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="medicoHistPaciente" class="form-control" id="medicoHistPaciente" value="<?php echo $row_historico['medicoHistPaciente']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="date" name="dataHistPaciente" class="form-control" id="dataHistPaciente" value="<?php echo $row_historico['dataHistPaciente']; ?>">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="exameHistPaciente">Tipo de Exame:</label>
                <input type="text" name="exameHistPaciente" class="form-control" id="exameHistPaciente" value="<?php echo $row_historico['exameHistPaciente']; ?>">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="medicamentoHistPaciente">Medicamento Prescrito:</label>
                <input type="text" name="medicamentoHistPaciente" class="form-control" id="medicamentoHistPaciente" value="<?php echo $row_historico['medicamentoHistPaciente']; ?>">
            ...
            <div class="row">
              <div class="col-md-10 mb-3">
                ...
                <textarea class="form-control" rows="4" name="resultadoHistPaciente" id="resultadoHistPaciente">
                  <?php echo $row_historico['resultadoHistPaciente']; ?>
                </textarea>
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
            </div>
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_historico_administrador.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
