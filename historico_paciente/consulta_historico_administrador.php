<?php
  ...
  $result_historico = "SELECT * FROM historico LIMIT $inicio, $qnt_result_pg"; 
...
<html lang="pt-br">
  ...
  <body>
      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 80px">Consultar Histórico do Paciente</h3>
        ...
        <?php
          ...
          <div class="container">
            <div class="container theme-showcase" role="main">
              ...
              <div class="row">
                ...
                <tbody>
                  <?php while($rows_historico = mysqli_fetch_assoc($resultado_historico)){ ?>
                    <tr>
                      <td>
                        <?php echo $rows_historico['id']; ?>
                      </td>
                      <td>
                        <?php echo $rows_historico['nomeHistPaciente']; ?>
                      </td>
                      <div class="col-md-3">
                        <td class="float-right">
                          <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#myModal<?php echo $rows_historico['id']; ?>"><i class='fa fa-eye'></i></button>
                          <button type="button" class="btn btn-xs btn-warning" data-target="#exampleModal">
                            <?php echo "<a href='editar_historico_administrador.php?id=" . $rows_historico['id']. "'><i class='fa fa-edit'></i></a>"?></button>
						  <button type="button" class="btn btn-xs btn-danger">
                            <?php echo "<a href='proc_apagar_historico_administrador.php?id=" . $rows_historico['id'] . "' data-confirm='Tem certeza que deseja excluir o item selecionado?'><i class='fa fa-trash-alt'></i></a>"?></button>	
						</td>
                      </div>
                    </tr>
              </div>
              ...
              <!--Inicio Modal -->
              <div class="modal fade" id="myModal<?php echo $rows_historico['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      <h4 class="modal-title text-left" id="myModalLabel"><?php echo $rows_historico['nomeHistPaciente']; ?></h4> </div>
                    <div class="modal-body">
                      <div class="container-fluid">
                        ...
                        <p>
                          <div class="row">
                            <div class="col-md-6">
                              <?php echo'<strong>Convênio: </strong>'.$rows_historico['convenioHistPaciente']; ?></div>
                          </div>
                        </p>
                        <p>
                          <div class="row">
                            <div class="col-md-6">
                              <?php echo'<strong>Médico Solicitante: </strong>'.$rows_historico['medicoHistPaciente']; ?></div>
                          </div>
                        </p>
                        <p>
                          <div class="row">
                            <div class="col-md-6">
                              <?php echo'<strong>Data da Solicitação: </strong>'.$rows_historico['dataHistPaciente']; ?></div>
                          </div>
                        </p>
                        <p>
                          <div class="row">
                            <div class="col-md-6">
                              <?php echo'<strong>Tipo de Exame: </strong>'.$rows_historico['exameHistPaciente']; ?></div>
                          </div>
                        </p>
                        <p>
                          <div class="row">
                            <div class="col-md-6">
                              <?php echo'<strong>Medicamento Prescrito: </strong>'.$rows_historico['medicamentoHistPaciente']; ?></div>
                          </div>
                        </p>
                        <p>
                          <div class="row">
                            <div class="col-md-8">
                              <?php echo'<strong>Resultados Obtidos: </strong>'.$rows_historico['resultadoHistPaciente']; ?></div>
                          </div>
                        </p>
						<hr class="mb-4">
                          <div class="row">
      ...
      <?php  
        ...
        echo "<span class='page-link'><a href='consulta_historico_administrador.php?pagina=1'>Primeira</a></span>";
        echo '</li>';
  
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
		  if($pag_ant >= 1){
		    echo "<li class='page-item'><a class='page-link' href='consulta_historico_administrador.php?pagina=$pag_ant'>$pag_ant</a></li>";
		    }
		}
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
		  if($pag_dep <= $quantidade_pg){
		    echo "<li class='page-item'><a class='page-link' href='consulta_historico_administrador.php?pagina=$pag_dep'>$pag_dep</a></li>";
		    }
		}
        echo '<li class="page-item">';
        echo "<span class='page-link'><a href='consulta_historico_administrador.php?pagina=$quantidade_pg'>Última</a></span>";
        echo '</li>';
        echo '</ul>';
        echo '</nav>';
