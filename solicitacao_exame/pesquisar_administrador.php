...
//Selecionar todos os exames da tabela
...
//Selecionar os exames a serem apresentado na página **** '%$valor_pesquisar%' limit $incio, $quantidade_pg ****
$result_exames = "SELECT * FROM exame WHERE nomePacienteExame LIKE '%$valor_pesquisar%'";
$resultado_exames = mysqli_query($conexao, $result_exames);
                  ...
                  <div class="col-sm-6 col-md-6">
                    <form class="form-inline" method="GET" action="pesquisar_administrador.php">
                      <div class="form-group">
						...
						<a class="btn btn-primary" href="consulta_exame_administrador.php" role="button">Voltar</a>
                      </div>
                    </form>
                  </div>
                </div>
