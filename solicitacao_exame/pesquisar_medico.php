...
if(!isset($_GET['pesquisar'])){
	header("Location: consulta_exame_medico.php");
}else{
	$valor_pesquisar = $_GET['pesquisar'];
}

//Selecionar todos os exame da tabela
$result_exame = "SELECT * FROM exame WHERE nomePacienteExame LIKE '%$valor_pesquisar%'";
$resultado_exame = mysqli_query($conexao, $result_exame);

//Selecionar os exame a serem apresentado na página **** '%$valor_pesquisar%' limit $incio, $quantidade_pg ****
$result_exame = "SELECT * FROM exame WHERE nomePacienteExame LIKE '%$valor_pesquisar%'";
$resultado_exame = mysqli_query($conexao, $result_exame);
$total_exame = mysqli_num_rows($resultado_exame);
?>
                  ...
                  <div class="col-sm-6 col-md-6">
                    <form class="form-inline" method="GET" action="pesquisar_medico.php">
                      <div class="form-group">
						...
						<a class="btn btn-primary" href="consulta_exame_medico.php" role="button">Voltar</a>
                      </div>
                    </form>
                  </div>
                </div>
                      ...
                      <div class="col-md-3">
                        <td class="float-right">
                          ...
                          <button type="button" class="btn btn-xs btn-warning" data-target="#exampleModal">
                            <?php echo "<a href='editar_exame_medico.php?id=" . $rows_exame['id']. "'><i class='fa fa-edit'></i></a>"?></button>
                          <button type="button" class="btn btn-xs btn-danger">
                            <?php echo "<a href='proc_apagar_exame_medico.php?id=" . $rows_exame['id'] . "' data-confirm='Tem certeza que deseja excluir o item selecionado?'><i class='fa fa-trash-alt'></i></a>"?></button>			
						</td>
                    </tr>
                    </div>
              </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="container-fluid">
                          ...
                          <hr class="mb-4">
                          <h5 class="modal-title text-center" id="myModalLabel">exame Solicitados:</h5>
                          <br>
                          <div class="row">
                            <div class="col-md-12">
                              <p>
                          ...
                          <div class="screen row">
							...
							<a class="btn btn-primary" href="consulta_exame_medico.php" role="button"><i class="fa fa-times"></i> Sair</a>
							</div>
                          </div>
                          </div>
                        </div>
