  ...
  <body>
    <div class="screen wrapper">
                      ...
                      <div class="col-md-3">
                        <td class="float-right">
                          ...
                          <button type="button" class="btn btn-xs btn-danger">
                            <?php echo "<a href='proc_apagar_exame_medico.php.php?id=" . $rows_exame['id'] . "' data-confirm='Tem certeza que deseja excluir o item selecionado?'><i class='fa fa-trash-alt'></i></a>"?></button>						
						</td>
                    </tr>
                    </div>
              </div>
      ...
      <?php  
        ...
        echo "<span class='page-link'><a href='cadastro_exame_medico.php?pagina=1'>Primeira</a></span>";
        echo '</li>';
  
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
		  if($pag_ant >= 1){
		    echo "<li class='page-item'><a class='page-link' href='cadastro_exame_medico.php?pagina=$pag_ant'>$pag_ant</a></li>";
		    }
		}
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
		  if($pag_dep <= $quantidade_pg){
		    echo "<li class='page-item'><a class='page-link' href='cadastro_exame_medico.php?pagina=$pag_dep'>$pag_dep</a></li>";
		    }
		}
        echo '<li class="page-item">';
        echo "<span class='page-link'><a href='cadastro_exame_medico.php?pagina=$quantidade_pg'>Última</a></span>";
        echo '</li>';
        echo '</ul>';
        echo '</nav>';
