    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_medicamento_atendimento.php">
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" name="genericoMedicamento" id="genericoMedicamento">
                  <option value="<?php echo $row_medicamento['id']; ?>">
            ...
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_medicamento_atendimento.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
