                  ...
                  <div class="col-sm-6 col-md-6">
                    <form class="form-inline" method="GET" action="pesquisar_atendimento.php">
                      <div class="form-group">
						...
						<a class="btn btn-primary" href="consulta_medicamento_atendimento.php" role="button">Voltar</a>
                      </div>
                    </form>
                  </div>
                </div>
                          ...
                          <div class="col-md-3">
                            <td class="float-right">
                              ...
                              <button type="button" class="btn btn-xs btn-warning" data-target="#exampleModal">
                                <?php echo "<a href='editar_medicamento_atendimento.php?id=" . $rows_cursos['id']. "'><i class='fa fa-edit'></i></a>"?></button>
							  <button type="button" class="btn btn-xs btn-danger">
								<?php echo "<a href='proc_apagar_medicamento_atendimento.php?id=" . $rows_cursos['id'] . "' data-confirm='Tem certeza que deseja excluir o item selecionado?'><i class='fa fa-trash-alt'></i></a>"?></button>
							</td>
                          </div>
                        </tr>
                </div>
