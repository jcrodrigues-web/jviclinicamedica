    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_medicamento_medico.php">
            <div class="row">
            ...
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_medicamento_medico.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
