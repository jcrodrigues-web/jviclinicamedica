<?php
  ...
  $result_medicamento = "SELECT * FROM medicamento WHERE id = '$id'";
  $resultado_medicamento = mysqli_query($conexao, $result_medicamento);
  $row_medicamento = mysqli_fetch_assoc($resultado_medicamento); 
?>
      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 140px">Editar Medicamento</h3>
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_medicamento_administrador.php">
            <div class="row">
              <div class="col-md-2 mb-3">
                <label for="id">Código:</label>
                <input type="text" name="id" class="form-control" id="id" value="<?php echo $row_medicamento['id']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-9 mb-3">
                <label for="nomeMedicamento">Nome do Medicamento:</label>
                <input type="text" name="nomeMedicamento" class="form-control" id="nomeMedicamento" value="<?php echo $row_medicamento['nomeMedicamento']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" name="genericoMedicamento" id="genericoMedicamento">
                  <option value="<?php echo $row_medicamento['genericoMedicamento']; ?>">
                    <?php echo $row_medicamento['genericoMedicamento']; ?>
                  </option>
                  <option></option>
                  <option>Sim</option>
                  <option>Não</option>
              ...
              <div class="col-md-7 mb-3">
                ...
                <input type="text" name="fabricanteMedicamento" class="form-control" id="fabricanteMedicamento" value="<?php echo $row_medicamento['fabricanteMedicamento']; ?>">
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-3 mb-3">
                ...
                <input type="text" name="tipoMedicamento" class="form-control" id="tipoMedicamento" value="<?php echo $row_medicamento['tipoMedicamento']; ?>">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="nomeGenMedicamento">Nome Genérico:</label>
                <input type="text" name="nomeGenMedicamento" class="form-control" id="nomeGenMedicamento" value="<?php echo $row_medicamento['nomeGenMedicamento']; ?>">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="nomeFabMedicamento">Nome de Fábrica:</label>
                <input type="text" name="nomeFabMedicamento" class="form-control" id="nomeFabMedicamento" value="<?php echo $row_medicamento['nomeFabMedicamento']; ?>">
            ...
            <div class="row">
              <div class="col-md-11 mb-3">
                ...
                <textarea class="form-control" rows="4" name="observacoesMedicamento" id="observacoesMedicamento">
                  <?php echo $row_medicamento['observacoesMedicamento']; ?>
                </textarea>
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
            </div>
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_medicamento_administrador.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
