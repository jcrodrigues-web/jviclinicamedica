      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 80px">Editar Cadastro de Funcionário</h3>
        ...
        <?php
			...
			?>
          <form class="form-horizontal" method="post" action="proc_editar_funcionario.php">
            <div class="row">
              <div class="col-md-3 mb-3">
                <label for="id">Código:</label>
                <input type="text" name="id" class="form-control" id="id" value="<?php echo $row_funcionario['id']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-9 mb-3">
                <label for="nomeFuncionario">Nome:</label>
                <input type="text" name="nomeFuncionario" class="form-control" id="nomeFuncionario" value="<?php echo $row_funcionario['nomeFuncionario']; ?>" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="cpfFuncinario">CPF:</label>
                <input type="text" name="cpfFuncionario" class="form-control" id="cpfFuncionario" placeholder="" value="<?php echo $row_funcionario['cpfFuncionario']; ?>" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" size="14" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="dataNascFuncionario">Data de Nascimento:</label>
                <input type="date" name="dataNascFuncionario" class="form-control" id="dataNascFuncionario" value="<?php echo $row_funcionario['dataNascFuncionario']; ?>">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="funcaoFuncionario">Função:</label>
                <select class="custom-select d-block w-100" name="funcaoFuncionario" id="funcaoFuncionario" value="<?php echo $row_funcionario['funcaoFuncionario']; ?>">
                  <option value="<?php echo $row_funcionario['funcaoFuncionario']; ?>">
                    <?php echo $row_funcionario['funcaoFuncionario']; ?>
                  </option>
                  <option></option>
                  <option>01-Fornecedor</option>
                  <option>02-Médico</option>
                  <option>03-Secretária</option>
                </select>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="telResFuncionario" class="form-control" id="telResFuncionario" placeholder="" value="<?php echo $row_funcionario['telResFuncionario']; ?>" onkeydown="javascript: fMasc( this, mTel );" maxlength="13" size="13">
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="celularFuncionario">Celular:</label>
                <input type="text" name="celularFuncionario" class="form-control" id="celularFuncionario" value="<?php echo $row_funcionario['celularFuncionario']; ?>" onkeydown="javascript: fMasc( this, mCel );" maxlength="14" size="14">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="emailFuncionario">Email: <span class="text-muted"></span></label>
                <input type="email" name="emailFuncionario" class="form-control" id="emailFuncionario" value="<?php echo $row_funcionario['emailFuncionario']; ?>">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="enderecoFuncionario" class="form-control" id="enderecoFuncionario" value="<?php echo $row_funcionario['enderecoFuncionario']; ?>">
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="bairroFuncionario">Bairro:</label>
                <input type="text" name="bairroFuncionario" class="form-control" id="bairroFuncionario" value="<?php echo $row_funcionario['bairroFuncionario']; ?>">
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="cidadeFuncionario">Cidade:<span class="text-muted"></span></label>
                <input type="text" name="cidadeFuncionario" class="form-control" id="cidadeFuncionario" value="<?php echo $row_funcionario['cidadeFuncionario']; ?>"> </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="estadoFuncionario">Estado:</label>
                <select class="custom-select d-block w-100" name="estadoFuncionario" id="estadoFuncionario" value="<?php echo $row_funcionario['estadoFuncionario']; ?>">
                  <option value="<?php echo $row_funcionario['estadoFuncionario']; ?>">
                    <?php echo $row_funcionario['estadoFuncionario']; ?>
                  </option>
              ...
              <div class="col-md-4 mb-3">
                <label for="paisFuncionario">País:</label>
                <select class="custom-select d-block w-100" name="paisFuncionario" id="paisFuncionario" value="<?php echo $row_funcionario['paisFuncionario']; ?>">
                  <option value="<?php echo $row_funcionario['paisFuncionario']; ?>">
                    <?php echo $row_funcionario['paisFuncionario']; ?>
                  </option>
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="cepFuncionario" class="form-control" id="cepFuncionario" value="<?php echo $row_funcionario['cepFuncionario']; ?>" onkeydown="javascript: fMasc( this, mCEP );" maxlength="10" size="10">
                <div class="invalid-feedback"> Zip code required. </div>
              </div>
            </div>
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_funcionario_administrador.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
