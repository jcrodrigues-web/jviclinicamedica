      ...
      <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color:#E8E8E8">
          <div class="container-fluid">
            ...
            <h3 class="h3" style="margin-left: 140px">Cadastrar de Funcionário</h3>
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="recebe_cadastro_funcionario.php" name="form1">
            <div class="row">
              <div class="col-md-8 mb-3">
                <label for="nomeFuncionario">Nome:</label>
                <input type="text" name="nomeFuncionario" class="form-control" id="nomeFuncionario" placeholder="Nome completo" required>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="cpfFuncinario" class="form-control" id="cpfFuncinario" placeholder="CPF" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" size="14" required>
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="dataNascFuncionario">Data de Nascimento:</label>
                <input type="date" name="dataNascFuncionario" class="form-control" id="dataNascFuncionario" placeholder="Data de Nascimento">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="funcaoFuncionario">Função:</label>
                <select class="custom-select d-block w-100" name="funcaoFuncionario" id="funcaoFuncionario">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="telResFuncionario" class="form-control" id="telResFuncionario" placeholder="Telefone residencial" onkeydown="javascript: fMasc( this, mTel );" maxlength="13" size="13">
                <div class="invalid-feedback"> Valid first name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="celularFuncionario">Celular:</label>
                <input type="text" name="celularFuncionario" class="form-control" id="celularFuncionario" placeholder="Celular" onkeydown="javascript: fMasc( this, mCel );" maxlength="14" size="14">
                <div class="invalid-feedback"> Valid last name is required. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="emailFuncionario">Email: <span class="text-muted"></span></label>
                <input type="email" name="emailFuncionario" class="form-control" id="emailFuncionario" placeholder="voce@example.com.br">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="enderecoFuncionario" class="form-control" id="enderecoFuncionario" placeholder="Rua / Número">
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="bairroFuncionario">Bairro:</label>
                <input type="text" name="bairroFuncionario" class="form-control" id="bairroFuncionario" placeholder="Bairro">
                <div class="invalid-feedback"> Please enter your shipping address. </div>
              </div>
              <div class="col-md-4 mb-3">
                <label for="cidadeFuncionario">Cidade:<span class="text-muted"></span></label>
                <input type="text" name="cidadeFuncionario" class="form-control" id="cidadeFuncionario" placeholder="Escolha a cidade"> </div>
            </div>
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="estadoFuncionario">Estado:</label>
                <select class="custom-select d-block w-100" name="estadoFuncionario" id="estadoFuncionario">
              ...
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" name="paisFuncionario" id="paisFuncionario">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="cepFuncionario" class="form-control" id="cepFuncionario" placeholder="CEP" onkeydown="javascript: fMasc( this, mCEP );" maxlength="10" size="10">
