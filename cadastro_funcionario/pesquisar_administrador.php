...
//Selecionar todos os funcionario da tabela
$result_curso = "SELECT * FROM funcionario WHERE nomeFuncionario LIKE '%$valor_pesquisar%'";
$resultado_curso = mysqli_query($conexao, $result_curso);

//Selecionar os funcionario a serem apresentado na página **** '%$valor_pesquisar%' limit $incio, $quantidade_pg ****
$result_funcionario = "SELECT * FROM funcionario WHERE nomeFuncionario LIKE '%$valor_pesquisar%'";
$resultado_funcionario = mysqli_query($conexao, $result_funcionario);
$total_funcionario = mysqli_num_rows($resultado_funcionario);
?>
                  ...
                  <div class="col-sm-6 col-md-6">
                    <form class="form-inline" method="GET" action="pesquisar_administrador.php">
                      <div class="form-group">
                        <input type="text" name="pesquisar" class="form-control" id="exampleInputName2" placeholder="Nome do funcionário">&nbsp
                        <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Pesquisar</button>&nbsp&nbsp
						<a class="btn btn-primary" href="consulta_funcionario_administrador.php" role="button">Voltar</a>
                      </div>
                    </form>
                  </div>
                </div>
