    ...
    <nav id="sidebar" style="background-color:#104E8B">
      ...
      <div id="content">
        ...
        <?php
          ...
          <form class="form-horizontal" method="post" action="proc_editar_paciente_atendimento.php">
            <div class="row">
            ...
            <hr class="mb-4">
            <button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Salvar</button> <a class="btn btn-info" href="consulta_paciente_atendimento.php"><i class="fa fa-reply"></i>Voltar</a> </form>
      </div>
      <div class="line"></div>
    </div>
